...
static void swapBuffersNSGL(_GLFWwindow *window)
{
    @autoreleasepool
    {
        ...
        {
            int interval = 0;
            [window->context.mgl.object getValues:&interval forParameter:NSOpenGLContextParameterSwapInterval];
...
static void swapIntervalNSGL(int interval)
{
    @autoreleasepool
    {
        ...
        if (window)
        {
            [window->context.mgl.object setValues:&interval forParameter:NSOpenGLContextParameterSwapInterval];
        }
...
#undef setAttrib
    ...
    window->context.mgl.pixelFormat = [[NSOpenGLPixelFormat alloc] initWithAttributes:attribs];
    ...
    window->context.mgl.object = [[NSOpenGLContext alloc] initWithFormat:window->context.mgl.pixelFormat
                                                            shareContext:share];
    ...
    {
        GLint opaque = 0;
        [window->context.mgl.object setValues:&opaque forParameter:NSOpenGLContextParameterSurfaceOpacity];
    }
