...
int main()
{
    ...
    float vertices[] = {-1.0f, -1.0f, 0.0f, 1.0f, 0.0f, 0.0f, 1.0f, -1.0f, 0.0f,
    ...
    glVertexArrayVertexBuffer(hctVAO,             // vao to bind
    ...
    //   replaced with:
    glVertexArrayAttribFormat(hctVAO, attribPos, 3, GL_FLOAT, false,
                              0); // Need to precise vao, as there is no context binding in DSA
    glVertexArrayAttribFormat(
        hctVAO, attribCol, 3, GL_FLOAT, false,
        3 * sizeof(float)); // https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glVertexAttribFormat.xhtml
